...
function register_styles(){
  ...
  wp_register_style('highlightjs', 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.8.0/styles/default.min.css');
  wp_register_style('main_font','https://fonts.googleapis.com/css?family=Montserrat:400,700');
  wp_register_script('highlightjsjs', 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.8.0/highlight.min.js');
